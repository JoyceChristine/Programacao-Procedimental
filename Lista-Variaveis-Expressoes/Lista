...
/*int main()
{
    ...
    printf("Antecessor %d e sucessor %d", ant, suc);
    return 0;
}*/
...
/*int main()
{
   ...
   hip = sqrt((a*a)+(b*b));
    ...
    printf("Resultado da hipotenusa e: %d", hip);
    return 0;
}*/
...
/*int main()
{
   ...
   resul = num - valor;
    ...
    printf("O valor com 12 porcento de desconto e: %f", resul);
    return 0;
}*/
...
/*int main()
{
    float salario,salarioNovo, valor;
    ...
    salarioNovo = salario + valor;

    printf("O salario com 25 porcento de aumento e: %f", salarioNovo);
    return 0;
}*/
